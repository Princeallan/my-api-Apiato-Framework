...
class ProxyLoginTest extends TestCase
{
    ...
    public function testClientWebAdminProxyLogin_()
    {
        ...
        // create.blade.php data to be used for creating the testing user and to be sent with the post request
        $data = [
        ...
        // create.blade.php testing oauth keys files
